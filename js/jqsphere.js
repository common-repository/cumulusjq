(function(){
    ...
    jQuery.fn.tagSphere = function(opt){ 
        ...
        if(jQuery('#width').val()){width = parseInt(jQuery('#width').val())}
        if(jQuery('#height').val()){height = parseInt(jQuery('#height').val())}
        if(jQuery('#radius').val()){radius = parseInt(jQuery('#radius').val())}
        if(jQuery('#speed').val()){speed = parseInt(jQuery('#speed').val())} 
    ...
    function initContainer(tagCont){
        var bg = '#FFF';
        if(jQuery('#bg').val()){bg = jQuery('#bg').val()} 
